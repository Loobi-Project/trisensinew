...
import { NavUserStaffTeacher } from '@/components/staffteacher/nav-user-staffteacher';
...
export function StaffTeacherSidebar() {
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton size="lg" asChild>
                            <Link href="/staffteacher/dashboard" prefetch>
                                <AppLogo />
                            </Link>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
